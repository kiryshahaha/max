# GUAP Student Portal - Полная система
...
└── miniapp/                   # Фронтенд приложение (Next.js + React)
    ...
    │   │   ├── schedule/      # Расписание
    │   │   ├── settings/      # Настройки
    │   │   └── tutors/        # Информация о преподавателях
    │   ├── components/        # React компоненты
    │   │   ├── BottomNavBar.jsx        # Нижняя панель навигации
    │   │   ├── ReportsTable.jsx        # Таблица отчетов
    │   │   ├── TasksTable.jsx          # Таблица задач
...
- **`deadlines/`** - Страница дедлайнов задач
- **`info/`** - Информационные страницы
...
- **`TasksTable.jsx`** - Таблица/список всех задач
- **`ReportsTable.jsx`** - Таблица всех отчетов
...
- Парсит расписание, задачи, оценки, отчеты
...
NEXT_PUBLIC_APP_NAME=GUAP Student Portal
```
...
- Информация: тип занятия (Л/ПР/ЛР), предмет, время, аудитория
- Компонент `ScheduleSection.jsx` отображает расписание

#### Текущие задачи

- Список всех активных задач через `TasksTable.jsx`
...
- Страница дедлайнов `/deadlines` с улучшенным представлением

#### Загруженные отчеты

- Список всех отправленных отчетов через `ReportsTable.jsx`
- Компонент `ReportsSection.jsx` для быстрого просмотра
- Дата загрузки
- Статус проверки (принят, на проверке, вернул)
  
#### Оценки студента

Получаются через API и отображаются:
- Оценки по всем дисциплинам
- Тип контроля (экзамен, зачет, контрольная работа)
- Статус (получена, ожидается)
- Кредиты по предметам
...
- Факультет
- Редактирование профиля (если доступно)
